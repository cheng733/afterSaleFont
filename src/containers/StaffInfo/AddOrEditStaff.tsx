...
React.useEffect(()=>{
  ...
  // const  handleTime = (date: any, dateString: any)=> {
...
<Form
      ...
      <Row>
        <Col>
          <Form.Item
            ...
            initialValue="在职"
          >
             <Select defaultValue="在职" style={{ width: 120 }} onChange={handleSelect}>
    ...
    <Form.Item
            ...
            initialValue="前台"
          >
          <Select defaultValue="前台" style={{ width: 120 }} onChange={handleSelect}>
