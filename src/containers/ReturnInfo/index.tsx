...
const ReturnInfo: React.FC = () => {
  ...
  const editInputHandle = async(e:any,_record:any)=>{
    console.log(e.target.value,_record)
    const value = e.target.value
    const response = await Http.reqEditProblemDescMaintenDetail("/editProblemDescMaintenDetail",{id:_record["id"],problemDesc:value})
