...
//服务委托
const reqAddCarMaintenAppoint = (url:string,params:any)=>ajax({url,params})
//委托单查询
const reqCarMaintenAppoint = (url:string,params:any)=>ajax({url,params})
//修改委托单状态
const reqEditStatusMaintenAppoint = (url:string,params:any)=>ajax({url,params})
//维修信息
...
//维修信息状态修改
const reqEditStatusMaintenDetail = (url:string,params:any)=>ajax({url,params})
//删除维修信息
const reqDelMaintenDetail = (url:string,params:any)=>ajax({url,params})
//维修信息插入问题描述
const reqEditProblemDescMaintenDetail = (url:string,params:any)=>ajax({url,params})
//获取用户信息
